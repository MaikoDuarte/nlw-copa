...
export default function Home(props: HomeProps) {
  ...
  return(
    <div className="max-w-[1124px] mx-auto grid grid-cols-2 gap-28 items-center mt-3">
      <main>
        ...
        <div className='mt-10 flex items-center gap-2'>
          ...
          <strong className='text-gray-100 texl-xl'>
        ...
        <form onSubmit={createPool} className='mt-10 flex gap-2'>
          ...
          />
          <button
          className='bg-yellow-500 px-6 rounded text-gray-900 font-bold text-sm uppercase hover:bg-yellow-700'
           type="submit"
        ...
        <div className='mt-10 pt-10 border-gray-600 flex justify-between items-center text-gray-100'>
